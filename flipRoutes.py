...
inputEventLayer = r'C:\Users\daniel.fourquet\Documents\Tasks\XD-to-LRS\Data\ArcGIS\Default.gdb\RichmondRegion'
idField = 'XDSegID'
rte_nmField = 'RTE_NM'
begin_mpField = 'BEGIN_MSR'
end_mpField = 'END_MSR'

outputEventCSV = r'C:\Users\daniel.fourquet\Documents\Tasks\XD-to-LRS\Output\RichmondRegionFlipped.csv'
